--- The p6m overlay standards (E1–E7), held against the .NET "empty" archetype — a platform
...
local VARIANTS = {
  ...
  },
  {
    ...
    build_command = "dotnet publish src/Legacy/Legacy.csproj -c Release -o /app/publish",
    runtime_artifact = "Legacy.dll",
  },
}
...
prova.group("dotnet-empty: the archetype itself", { tags = { "standards" } }, function(g)
