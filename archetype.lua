-- .NET Service Platform Overlay ("empty" archetype).
--
...
--
--   archetect render .../dotnet-service-empty-archetype /path/to/existing-project
--
...
-- No root-namespace prompt: nothing the overlay renders (CI, Dockerfiles,
-- Tiltfile, platform manifests) references it. The carried Dockerfiles refer
-- only to the PascalCase project name derived from the project library, so
-- prompting for a namespace would be noise.
